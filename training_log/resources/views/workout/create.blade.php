...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white shadow-md rounded-lg px-8 pb-8">
        <h2 class="text-xl font-medium mb-4">Új edzés rögzítése</h2>
        <form action="{{route('workout.store')}}" method="post">
            ...
            <div class="mb-4">
                ...
                <input type="number" name="wTime" id="wTime"
                    class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500">
                @error('wTime')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="number" name="wAvg_pulse" id="wAvg_pulse"
                    class="w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-1 focus:ring-blue-500">
                @error('wAvg_pulse')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <button type="submit"
                class="inline-block px-4 py-2 rounded-md bg-blue-500 text-white font-medium focus:outline-none hover:bg-blue-700">Mentés</button>
        </form>
    </div>
</div>
@endsection